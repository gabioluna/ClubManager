...
import { Court, CourtType, Reservation, ReservationStatus, SurfaceType, User, Product, Client, ReservationTypeMeta } from "./types";
...
export const RESERVATION_META: Record<string, ReservationTypeMeta> = {
    'Normal': { label: 'Normal', color: '#1B3530', twColor: 'bg-[#1B3530] text-[#C7F269]' },
    'Fijo': { label: 'Fijo / Abonado', color: '#3B82F6', twColor: 'bg-blue-600 text-white' },
    'Clase': { label: 'Clase / Escuela', color: '#9333EA', twColor: 'bg-purple-600 text-white' },
    'Torneo': { label: 'Torneo', color: '#F97316', twColor: 'bg-orange-500 text-white' },
    'Cumpleaños': { label: 'Cumpleaños', color: '#EC4899', twColor: 'bg-pink-500 text-white' }
};
...
export const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Carlos Dueño', role: 'OWNER', email: 'dueno@club.com', status: 'ACTIVE', password: '123' },
  { id: 'u2', name: 'Laura Encargada', role: 'ADMIN', email: 'encargado@club.com', status: 'ACTIVE', password: '123' },
  { id: 'u3', name: 'Pedro Empleado', role: 'RECEPTIONIST', email: 'empleado@club.com', status: 'ACTIVE', password: '123' }
];
